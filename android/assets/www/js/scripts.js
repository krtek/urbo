...
/*
 * @param photoId which returns api for photo upload after it successfully upload photo
 *  */
    ...
    require(["dojo/_base/xhr", "dojo/dom", "dojo/_base/array", "dojo/domReady!"],
        ...
        var jsonObj = {
            "feedback": {
               ...
               "latitude": urboItem.Location.Latitude.value,
               "longitude": urboItem.Location.Longitude.value,
               "photo_id": photoId
           }
       }
